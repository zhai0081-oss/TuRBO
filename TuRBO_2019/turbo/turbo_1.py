...
class Turbo1:
    ...
    def __init__(
        ...
        self.lengthscales = np.zeros((0, self.dim)) if self.use_ard else np.zeros((0, 1)) # ARD: Each input dimension in the kernel function is assigned its own independent length-scale hyperparameter l_d
